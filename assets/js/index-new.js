  ...
  $(document).ready(function(){
    ...
    $('.photoshop-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          $(this).addClass('active');
          $(this).removeClass('not-active');
          // Cookies.set("filter", "photoshop", { expires: 1 });
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.photoshop, .mouse-pos-list-image-wrap li.photoshop, .work-tiles li.photoshop').addClass('visible');
          }, 300);
      }
    });
    $('.video-btn').click(function(){
      if ($(this).hasClass('active')) {
          ...
          $(this).addClass('active');
          $(this).removeClass('not-active');
          // Cookies.set("filter", "video", { expires: 1 });
          setTimeout(function() {
            $('.mouse-pos-list-image li, .mouse-pos-list-image-wrap li, .work-tiles li').removeClass('visible');
            $('.mouse-pos-list-image li.video, .mouse-pos-list-image-wrap li.video, .work-tiles li.video').addClass('visible');
          }, 300);
      }
    });
